...
import { Image, Text, TouchableOpacity, View, NativeModules, Alert } from 'react-native';
import { NetConnectionModal } from './components/NetConnectionModal';
import { styles } from '../style/styles';
import { cartUrl, cartItemsUrl } from "../data/settings";
import NotifService from './components/NotifServer';
...
export default class Product extends React.PureComponent {
	...
	componentDidMount() {
		this.notif = new NotifService(this.onNotif);
	}
	...
	handleAddToCart = async () => {
		...
		if (cartString.status === 200) {
			...
			if (cartResponse.message) {
				...
				this.notif.localNotif('Product is added to cart', 'Product is added', `${cartResponse.qty} of ${cartResponse.name} added`);
			}
